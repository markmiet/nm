...
public class SudenkorentoController : BaseController
{
    ...
    */
    ...
    void OnCollisionEnter2D(Collision2D col)
    {
        ...
        if (col.collider.tag.Contains("tiilivihollinen") || col.collider.tag.Contains("eituhvih") || col.collider.tag.Contains("sudenkorentovihollinenexplodetag"))
        {
            ...
            HitCounter hc =
            GetComponent<HitCounter>();
            if (hc != null)
            {

                if (hc.teerajaytaspriteuusiversio)
                {
                    RajaytaSpriteUusiMonimutkaisin(gameObject, uusirajaytyscolumns, uusirajaytysrows, hc.rajahdysvoima, hc.alivetime,
        hc.rajaytaSpritenExplosion, hc.rajaytaspritenviive, hc.gameJostaRajaytyksenPistelasketaan,
        36, hc.teeBoxCollider2d, hc.gravityscale, hc.rajaytaspritenScaleFactorProsentti
